<template>
    <div class="container" :class="{'sign-up-mode':signMode}">
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    ...
                    <p>何以解忧,唯有米修</p>
                    <button  v-on:click="signMode = !signMode" class="btn transparent">
                        注册
                    </button>
                </div>
...
<script>
    ...
    export default {
        ...
        setup(){
            ...
            return {signMode,loginUser, rules, registerUser,registerRules};
        },
